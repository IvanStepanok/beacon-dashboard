...
A confident, institutional-yet-modern narrative page: the calm authority of a UN
field manual crossed with the kinetic energy of a live operations room. Density 4
...
## 2. Color Palette & Roles (UNDP Design System primitives — non-negotiable)
...
* **Buttons:** flat UNDP Blue fill, 0.375rem radius (institutional sharpness),
  white 600-weight label, hover → Deep Blue, active → translate-y 1px. Ghost
